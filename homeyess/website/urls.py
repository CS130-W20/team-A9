...
urlpatterns = [
    ...
    path('ViewRideForm/<int:ride_id>/', views.viewrideform, name='ViewRideForm'),
    path('ViewRideForm/<int:ride_id>/Update', views.RequestRideEdit.as_view(), name='update_ride'),
    path('request-ride', views.RequestRideCreate.as_view(), name='request_ride'),
    path('ViewRideForm/<int:ride_id>/Delete', views.DeleteRideRequest, name='delete_ride'),
