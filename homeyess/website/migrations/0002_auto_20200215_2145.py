...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='profile',
            name='user_type',
            field=models.CharField(choices=[(website.models.Profile.UserType['Volunteer'], 'V'), (website.models.Profile.UserType['Homeless'], 'H'), (website.models.Profile.UserType['Company'], 'C')], default=website.models.Profile.UserType['Homeless'], max_length=100),
        ),
